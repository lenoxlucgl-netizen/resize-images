			...
			try {
				...
				data.keys.forEach(function(k) {
					...
					item.innerHTML = '<div class="key-info">'
						...
						+ '<span class="key-meta">Bucket: ' + (k.bucket === '*' ? 'Tutti (Nessun Limite)' : k.bucket) + ' · ' + date + '</span>'
